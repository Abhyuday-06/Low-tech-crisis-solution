...
Its purpose is to codify expert knowledge to help us make consistent, logical decisions under stress. It is NOT a magic "AI" that thinks. It is an Expert System, a checklist made of code.
...
Run the command: python crisis_advisor.py

The main menu will appear.

Type 1 for the Medical Advisor or 2 for the Weather Advisor.

Answer the simple questions it asks. It only understands the options it gives you (e.g., y, n, mild, severe).

It will give you a CRITICAL, WARNING, ADVICE, or INFO level recommendation.

Type q to quit the program and conserve power.
...
====================
CRITICAL: Fever + Severe Headache + Dizziness. Possible severe infection (e.g., meningitis) or other critical infections. Monitor vital signs frequently. Attempt to cool patient with damp cloths. Isolate if possible.
====================

Press Enter to continue...


3. (BONUS) THE PAPER-BASED ADVISOR
...
YES: -> ADVICE: CRITICAL! Possible severe infection/meningitis. Monitor vitals. Cool patient. Isolate. (END)
...
YES: -> ADVICE: HIGH-CONFIDENCE! Probable dehydration. Give 1L water + 1tsp salt + 6tsp sugar. (END)

NO: -> ADVICE: LOW-CONFIDENCE. Possible exhaustion/low blood sugar. Give food/sugar/water. Rest. (END)
...
If the system fails to recognise these rules, it breaks.

There's no actual intelligence in this solution as it's rule-based.

It's limited to certain keywords, actions only.
